 ...
 * </p>
 */
public interface Site extends Edit, Comparable<Object>, Serializable, AuthzGroup
{
	/**
	...
	List<? extends SitePage> getPages();
	...
	List<? extends SitePage> getOrderedPages();
	 ...
	 */
	Collection<? extends Group> getGroupsWithMember(String userId);
	 ...
	 */
	Collection<? extends Group> getGroupsWithMemberHasRole(String userId, String role);
